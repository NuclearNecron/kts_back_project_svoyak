...
def upgrade() -> None:
    ...
    sa.Column('RemainingQuestions', postgresql.ARRAY(sa.Integer()), nullable=True),
    sa.ForeignKeyConstraint(['winner'], ['admin.id'], ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('questionpack',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['player'], ['player.tg_id'], ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['pack'], ['questionpack.id'], ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
